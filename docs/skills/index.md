...
-   :material-flash-outline:{ .lg .middle } __expense-policy-checker__
    ...
    [:octicons-arrow-right-24: View skill](expense-policy-checker.md)
...
-   :material-flash-outline:{ .lg .middle } __invoice-extractor__
    ...
    [:octicons-arrow-right-24: View skill](invoice-extractor.md)
...
-   :material-flash-outline:{ .lg .middle } __meeting-summarizer__
    ...
    [:octicons-arrow-right-24: View skill](meeting-summarizer.md)
...
-   :material-flash-outline:{ .lg .middle } __onboarding-checklist__
    ...
    [:octicons-arrow-right-24: View skill](onboarding-checklist.md)
...
-   :material-flash-outline:{ .lg .middle } __vendor-risk-review__
    ...
    [:octicons-arrow-right-24: View skill](vendor-risk-review.md)
...
-   :material-flash-outline:{ .lg .middle } __weekly-report-writer__
    ...
    [:octicons-arrow-right-24: View skill](weekly-report-writer.md)
